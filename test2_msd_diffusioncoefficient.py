...
# path3 = 'D:\\guan2019\\1_disk\\TLc\\all_1\\analysis_delta2\\msd\\msd2\\'

# path3 = 'D:\\guan2019\\1_disk\\TLc\\all_1\\analysis\\msd_rot\\msd_rot1\\'
path3 = 'D:\\guan2019\\1_disk\\TLc\\all_1\\analysis\\msd\\msd1\\'

# path3 = 'C:\\Users\\guan\\Desktop\\2\\1_a\\msd\\delta0\\5g\\'  # 5g不同频率
...
# ----------------------------------------
    ...
    plt.plot(TAU, diff_coef*0.54**2, 'o-', markerfacecolor='none')
    store.close()
...
ax.set_ylabel('Local slope')#'Dr(mm^2/s)')
plt.legend(label)
plt.show()
